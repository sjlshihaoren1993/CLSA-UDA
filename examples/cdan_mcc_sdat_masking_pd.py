...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    for i in range(args.iters_per_epoch):
        ...
        x_t, _, x_t_filename, _ = next(train_target_iter)
        ...
        y_t_masked_softmax = torch.softmax(y_t_masked.detach(), dim=1)
        y_t_masked_prob, y_t_masked_label = torch.max(y_t_masked_softmax, dim=1)
